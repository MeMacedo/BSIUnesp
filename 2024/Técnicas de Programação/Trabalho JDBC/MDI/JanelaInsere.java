...
public class JanelaInsere extends JInternalFrame implements ActionListener {
    ...
    public JanelaInsere(JDesktopPane d, Connection conn) {
        super("Insere na tabela", false, true, false, true); // resizable, closable, maximizable, iconifiable
        desktop = d;
        con = conn;
        ...
        panel2.add(button = new JButton("Inserir"));
        add(panel);
        add(panel2);
    ...
    private void insertBeast(){
        static String beastStmt = ;
