/*5. Considere uma estrutura de hashing que utilize estrutura est·tica para alocaÁ„o dos
elementos, e estruturas din‚micas, associadas a cada posiÁ„o, para inserÁ„o dos elementos
conflitantes (resultantes de colis„o). Desenvolva rotinas para inserÁ„o, busca e remoÁ„o de
elementos da tabela.*/
